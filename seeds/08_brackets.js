  ...
  return knex('brackets').del()
    .then(function () {
      ...
      return knex('brackets').insert([
        ...
        {bracket_id: 'aaaa8206-78cb-4c59-8125-dc8ca3c8fe97', event_id: '11094d2c-108e-4a58-945c-9f260d5d7cf0', bracket_size: 16, bracket_level:'A'},
        {bracket_id: 'cccc13bb-0a6b-4991-88d9-594aedaf5e6c', event_id: '11094d2c-108e-4a58-945c-9f260d5d7cf0', bracket_size: 8, bracket_level:'C'},
        {bracket_id: 'bbbb5062-cfc6-455c-a8bc-fb3361487337', event_id: '11094d2c-108e-4a58-945c-9f260d5d7cf0', bracket_size: 4, bracket_level:'B'},
        {bracket_id: 'dddd5651-db68-40b0-8e80-6194d9acb586', event_id: '11094d2c-108e-4a58-945c-9f260d5d7cf0', bracket_size: 4, bracket_level:'D'},
